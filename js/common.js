...
function initProvince(prefix, country) {
  ...
  var o = {
    get: function() {
      ...
      if (value != '') {
        q = this.id.replace(prefix, '') + '=' + encodeURIComponent(value);
      }
      return q;
    },
    callBack: function() {
      if ($E(prefix + 'district')) {
  ...
  if ($E(prefix + 'district')) {
    ...
    initAutoComplete(
      prefix + 'amphur',
      WEB_URL + 'index.php/index/model/autocomplete/amphur?nodistrict=1&country=' + country,
      'amphur,province',
      'location',
      o
    );
    initAutoComplete(
      prefix + 'province',
      WEB_URL + 'index.php/index/model/autocomplete/province?nodistrict=1&country=' + country,
      'amphur,province',
      'location',
      o
    );
