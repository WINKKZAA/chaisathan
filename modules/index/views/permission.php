...
class View extends \Gcms\View
{
    ...
    public function render(Request $request)
    {
        ...
        $table = new DataTable(array(
            ...
            'hideColumns' => array('id', 'status', 'permission'),
        ...
        setcookie('permission_sort', $table->sort, time() + 2592000, '/', HOST, HTTPS, true);
        // คืนค่า HTML
        return $table->render();
    }
    ...
    {
        $item['username'] = '<a href="index.php?module=editprofile&amp;id='.$item['id'].'">'.$item['username'].'</a>';
        $item['name'] = '<span class=status'.$item['status'].'>'.$item['name'].'</span>';
